...
public class FastBuildPlayerWindow : EditorWindow
{
    ...
    public const string cachePath = "../../FastSwitchPlatform/";
    ...
    void OnGUI()
    {
        ...
        {
            SwitchPlatform(selectedBuildTarget);
        }
    ...
    {
        var activeBuildTarget = EditorUserBuildSettings.activeBuildTarget;
        var activeBuildTargetCachePath = cachePath + activeBuildTarget + "_metadata";
        var selectedBuildTargetCachePath = cachePath + targetPlatform + "_metadata";
